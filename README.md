...
### Recent Projects
- **[AliasT](https://github.com/ChrisWoo0443/AliasT)** - AliasT is a macOS zsh plugin that brings Warp-style inline ghost-text autocompletion and natural-language-to-command generation to any terminal emulator, powered by a Rust daemon with pluggable AI backends.                    
